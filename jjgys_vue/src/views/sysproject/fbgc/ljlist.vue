...
<div class="app-container">
    ...
    <div class="tool-div"  >
      ...
      <el-row>
        ...
        <el-col :span="4">
          <el-card shadow="hover" align="middle"  class="content" @click.native="ljwc()"> 路基弯沉 </el-card>
        </el-col>
        <el-col :span="4">
...
export default {
    ...
    ljwc() {
      ...
      //this.$router.push({path:"/jjgfbgc/ljgc/ljwc",query:{projecttitle:projecttitle,htdname:this.htdname,fbgcName:this.fbgcName}});
    },
    ljbp() {
      let projecttitle = this.$route.query.projecttitle;
