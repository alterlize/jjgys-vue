...
<div class="app-container">
    ...
    <div class="tool-div">
      ...
      <el-row>
        <el-col :span="4">
          <el-card shadow="hover" class="content" align="middle" style="font-size: 15px;" @click.native="hntlmjzd()"> 隧道沥青路面压实度 </el-card>
        </el-col>
        <el-col :span="4">
          <el-card shadow="hover" class="content" align="middle" style="font-size: 15px;" @click.native="sfz()"> 隧道沥青路面渗水系数 </el-card>
        </el-col>
        <el-col :span="4">
          <el-card shadow="hover" class="content" align="middle" style="font-size: 15px;" @click.native="ljx()"> 隧道混凝土路面强度 </el-card>
        </el-col>
        <el-col :span="4">
          <el-card shadow="hover" class="content" align="middle" style="font-size: 15px;" @click.native="ljxql()"> 隧道砼路面相邻板高差 </el-card>
        </el-col>
        <el-col :span="4">
          <el-card shadow="hover" class="content" align="middle" style="font-size: 15px;" @click.native="ljxsd()">  隧道路面构造深度手工铺砂法 </el-card>
        </el-col>
        <el-col :span="4">
          <el-card shadow="hover" class="content" align="middle" style="font-size: 15px;" @click.native="ljxhntlm()"> 隧道沥青路面厚度钻芯法 </el-card>
        </el-col>
      </el-row>
      <el-row>
       
        <el-col :span="4">
          <el-card shadow="hover" class="content" align="middle" style="font-size: 15px;" @click.native="ljxsd()"> 隧道混凝土路面厚度钻芯法 </el-card>
        </el-col>
        <el-col :span="4">
